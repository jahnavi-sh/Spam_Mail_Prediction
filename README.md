...
Machine learning algorithm used for the model - Logistic Regression model 
NumPy library 
Pandas library 
...
Message - this contains the textual column of the mail. 
...
copy : Return a copy when copy=True
...
Return value - a pandas dataframe with the changes set according to the specified dtype(s).
